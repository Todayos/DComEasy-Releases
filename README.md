...
**图例：** ✅ 已包含　🟡 有限制　⭐ 专业版专属　— 不提供

| 功能 | 免费基础版 | 专业版 |
| --- | --- | --- |
| 配置诊断、DCOM 权限及组件状态查看 | ✅ 已包含 | ✅ 已包含 |
| 本地 OPC 用户验证 | ✅ 已包含 | ✅ 已包含 |
| 配置变更预览 | ✅ 已包含 | ✅ 已包含 |
| OPC DA 基础连接测试 | ✅ 已包含 | ✅ 已包含 |
| OPC 节点浏览和完整点名查询 | ✅ 已包含 | ✅ 已包含 |
| 单个点位读取一次 | ✅ 已包含 | ✅ 已包含 |
| 网络、端口和防火墙状态检查 | ✅ 已包含 | ✅ 已包含 |
| 连接历史、日志、错误详情和中英文界面 | ✅ 已包含 | ✅ 已包含 |
| PDF 诊断报告 | 🟡 带免费版水印 | ✅ 无水印 |
| 创建本地 OPC 用户 | — | ⭐ 专业版专属 |
| 执行 DCOM 配置 | — | ⭐ 专业版专属 |
| 移除已有 DCOM 权限 | — | ⭐ 专业版专属 |
...
可通过邮件申请 DComEasy 专业版免费试用 1 个月。专业版用户可以将完整 DComEasy 客户端部署到客户机，再输入收到的激活码使用。申请方式见[免费试用说明与邮件模板](docs/free-trial.md)。
